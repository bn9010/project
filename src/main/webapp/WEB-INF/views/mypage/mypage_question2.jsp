...
<div class="col-md-9" style="height: 700px; background-color: #fff">
	...
	<thead>
 	...
 	<img src="${pageContext.request.contextPath}/resources/images/Declaration.jpg">
 	<h1>레시피에 문제가있나요?신고해주시면 신속하게 처리하겟습니다!</h1>
 	<button class="btn btn-danger btn-lg" onclick="location.href=mypagereport">등록하기</button>
 	</th>
 	</tr>
 	</tbody>
 	</table>
