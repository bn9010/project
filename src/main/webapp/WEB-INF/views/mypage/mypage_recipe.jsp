...
<nav class="navbar navbar-default navbar-static-top" style="text-align: left;">
  <div class="container" style=" float: left;">
    <ul style="list-style:none;">
     <li style="float: left;">
     	<a class="btn btn-default" href="mypage" style="text-decoration: none;">등록한 레시피</a>
     </li>
     <li style="float: left; margin-left: 20px;">
     	<a class="btn btn-default" href="mypagenotice" style="text-decoration: none;">등록한 게시판</a>
     </li>
    </ul>
  </div>
</nav>
	<div align="left" style="display: inline-block; margin-left: 15px;" >
		<a href="#" style="text-decoration: none;"><img src="${pageContext.request.contextPath}/resources/images/donkatsu.jpg" class="img-thumbnail">
		<p style="margin-left: 30px;">돈카츠 만들기</p></a>
	</div>
	<div align="left" style="display: inline-block; margin-left: 15px;" >
		<a href="#" style="text-decoration: none; "><img src="${pageContext.request.contextPath}/resources/images/donkatsu.jpg" class="img-thumbnail">
		<p style="margin-left: 30px;">돈카츠 만들기</p></a>
