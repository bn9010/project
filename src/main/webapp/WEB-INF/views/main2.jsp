...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/mainhover.css" />
<link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/bootstrap/bootstrap.css" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/bootstrap/bootstrap.min.css" />

<link rel="stylesheet/less" type="text/css" href="${pageContext.request.contextPath}/resources/less/image.less" />
...
<header id="header">
   ...
   <div class="col-md-8" style="background-color: #fff; margin-top: 15px; margin-bottom: 15px;">
	<div class="wrapper">
		 <h2><label>최신레시피</label></h2>
			<c:forEach items="${rlist }" var="dto">
  				<div class="item" id="first">
   					 <a href="recipesee?rnum=${dto.rnum }" class="textno">
   	 			<div class="polaroid">
   ...
   <div class="col-md-2"></div>
    ...
    <div class="col-md-8"  style="background-color: #fff; margin-top: 15px; margin-bottom: 15px;">
	<div class="wrapper">
		    <h2><label>인기레시피</label></h2>
			<c:forEach items="${rlist2 }" var="dto">
  				<div class="item" id="first">
   					 <a href="recipesee?rnum=${dto.rnum}" class="textno">
   	 			<div class="polaroid">
    					<img style="width: 300px; height:300px" 
...
<div class="col-md-2"></div>
	<div class="col-md-8" style="background-color: #fff; margin-top: 15px; margin-bottom: 15px;">
	<h4 align="left"><strong style="color: #289F5D;" >YOLO의 쉐프들</strong></h4>
	<div class="wrapper" align="left">
    	<a href="chef">
      <img src="${pageContext.request.contextPath}/resources/images/gimgeran.jpg" style="border-radius: 50%; width: 70px; height: 70px;">
 	
 		<h4><strong>김계란</strong></h4></a>
  </div>
	</div>
	<div class="col-md-2"></div>
	</div>
...
$(window).load(function(){
	...
	$("#page-loading").delay("1700").fadeOut();;
