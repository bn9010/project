...
body .container .half.bg {
  background-image: url("${pageContext.request.contextPath}/resources/images/deco.jpg");
			        ...
			        <div class="content">
				            <div class="signin-cont cont">
					                <form action="alogin" method="post" enctype="multipart/form-data" >
						                    <input type="text" name="aid"  class="inpt" required="required" placeholder="Admin ID">
						                    <label for="text">Admin ID</label>
						                    <input type="password" name="apass" id="password" class="inpt" required="required" placeholder="Admin PW">
